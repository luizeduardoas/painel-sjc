...
!function (e) {
    ...
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files,
            ...
            e.fn.uploadFile = function (t) {
                function r() {
                    D || (D = !0, function e() {
                        if (w.sequential || (w.sequentialCount = 99999), 0 == x.length && 0 == F.length)
                    ...
                    for (var o = 0; o < r.length; o++)
                        if (n(t, a, r[o].name))
                            if (a.allowDuplicates || !d(t, r[o].name))
                                ...
                                if (-1 != a.maxFileCount && t.selectedFiles >= a.maxFileCount)
                    ...
                    p.change(function () {
                        ...
                        if (this.files) {
                            ...
                            var u = e(this).val(),
                                    p = [];
                            if (i.push(u), !n(t, o, u))
                                return void(o.showError && e("<div class='" + o.errorClass + "'><b>" + u + "</b> " + o.extErrorStr + o.allowedTypes + "</div>").appendTo(t.errorLog));
                            if (p.push({
                                name: u,
                                size: "NA"
                            }), 0 == o.onSelect(p))
                        ...
                        if (c(o, t), s.unbind("click"), d.hide(), h(t, r, o, s), d.addClass(r), o.serialize && a.fileapi && a.formdata) {
                            ...
                            for (var w = "", g = 0; g < i.length; g++)
                                o.showFileCounter ? w += t.fileCounter + o.fileCounterStyle + i[g] + "<br>" : w += i[g] + "<br>",
                                        t.fileCounter++;
                ...
                function f(a, t) {
                    return this.statusbar = e("<div class='ajax-file-upload-statusbar'></div>").width(t.statusBarWidth),
                            ...
                            this.del = e("<div>" + t.deleteStr + "</div>").appendTo(this.statusbar).hide(),
                ...
                var w = e.extend({
                    ...
                    sequentialCount: 2,
                    customProgressBar: !1,
                    abortButtonClass: "btn btn-sm btn-danger ajax-file-upload-abort",
                    cancelButtonClass: "btn btn-sm btn-danger ajax-file-upload-cancel",
                    dragDropContainerClass: "ajax-upload-dragdrop",
                    dragDropHoverClass: "state-hover",
                    errorClass: "ajax-file-upload-error",
                    uploadButtonClass: "btn btn-primary btn-md ajax-file-upload",
                ...
                e(b).addClass(w.uploadButtonClass),
                        ...
                        this.update = function (a) {
                            w = e.extend(w, a),
                                    a.hasOwnProperty("url") && e("form").each(function (t, r) {
