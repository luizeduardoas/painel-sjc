    ...
    } catch (b)
    {
            ...
            ace.demo = {
                ...
                init: function (a)
                {
                    ...
                    if ("undefined" == typeof requirejs || a)
                        for (var b in ace.demo.functions)
        ...
        function (a, b)
        {
            function c(b, c)
            {
                ...
                this.settings = a.extend(
                        {}, a.fn.ace_sidebar.defaults, c, g), this.minimized = !1, this.collapsible = !1, this.horizontal = !1, this.mobile_view = !1, this.vars = function ()
                {
                    return {
            ...
            a(document).on("settings.ace", function (b, c, d, e, f)
            {
                ...
                navbar_fixed: function (b, c, d, e)
                {
                    if (ace.vars.very_old_ie)
                        return !1;
                    var b = b || "#navbar";
                    if ("string" == typeof b && (b = a(b).get(0)), !b)
                        return !1;
                    var f, c = c || !1,
                            d = "undefined" != typeof d ? d : !0;
                    if (a(document).trigger(f = a.Event("presettings.ace"), ["navbar_fixed", c, b, d]), f.isDefaultPrevented())
                        return !1;
                    if (e !== !1 && !c)
                    {
                        var g = a("#sidebar");
                ...
                sidebar_fixed: function (b, c, d, e)
                {
                    ...
                    var f, c = c || !1,
                            d = "undefined" != typeof d ? d : !0;
                    if (a(document).trigger(f = a.Event("presettings.ace"), ["sidebar_fixed", c, b, d]), f.isDefaultPrevented())
                        return !1;
                ...
                main_container_fixed: function (b, c, d)
                {
                    ...
                    if ("string" == typeof b && (b = a(b).get(0)), !b)
                        return !1;
                    var e;
                    if (a(document).trigger(e = a.Event("presettings.ace"), ["main_container_fixed", c, b, d]), e.isDefaultPrevented())
                        return !1;
