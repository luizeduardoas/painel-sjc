...
!function (a, b)
{
    var c = function (b, c)
    {
        ...
        {
            b && (n = a.extend(
                    {}, n, b)), this.destroy(), this.create(), _ = !0, this.reset(!0)
        }, this.update = function (b)
        {
            b && (n = a.extend(
                    {}, n, b)), this.size = n.size || this.size, this.lock = n.mouseWheelLock || this.lock, this.lock_anyway = n.lockAnyway || this.lock_anyway, W = n.hideOnIdle || W, X = n.hideDelay || X, Z = n.observeContent || !1, S = n.dragEvent || !1, "undefined" != typeof b.styleClass && (L && A.removeClass(L), L = b.styleClass, L && A.addClass(L), M = !!L.match(/scroll\-left|scroll\-top/))
        }, this.start = function ()
        {
            z[s] = 0
        }, this.end = function ()
            ...
            var c = function (b, c)
            {
                ...
                }), i = f.next().find("a.selected"), this.pick = function (c, d)
                {
                    ...
                    } else if ("string" == typeof c)
                    {
                        ...
                        if (c = j.indexOf(e), -1 == c && d === !0 && (j.push(e), a("<option />").appendTo(f).val(e), a('<li><a class="colorpick-btn"></a></li>').appendTo(k).find("a").css("background-color", e).data("color", e), c = j.length - 1), -1 == c)
                            return;
        ...
        function (a, b)
        {
            var c = "multiple" in document.createElement("INPUT"),
                    ...
                    g = function (b, c)
                    {
                        ...
                        this.settings = a.extend(
                                {}, a.fn.ace_file_input.defaults, c, e), this.$element = a(b), this.element = b, this.disabled = !1, this.can_reset = !0, this.$element.off("change.ace_inner_call").on("change.ace_inner_call", function (a, b)
                        {
            ...
            }, g.prototype.apply_settings = function ()
            {
                ...
                if (e)
                {
                    ...
                    {
                        if (a.preventDefault(), !b.can_reset)
                            return !1;
                        var c = !0;
                        if (b.settings.before_remove && (c = b.settings.before_remove.call(b.element)), !c)
                            return !1;
                        b.reset_input();
                        return !1
                    })
            ...
            }, g.prototype.show_file_list = function (b, c)
            {
                ...
                if (d && 0 != d.length)
                {
                    ...
                    for (var g = 0; g < d.length; g++)
                    {
                        var h = "",
                                i = !1;
                        if ("string" == typeof d[g])
                            h = d[g];
                        else if (f && d[g] instanceof File)
                            h = a.trim(d[g].name);
                        else
                        {
                            if (!(d[g] instanceof Object && d[g].hasOwnProperty("name")))
                                continue;
            ...
            {
                this.settings = a.extend(
                        {}, this.settings, b), this.apply_settings()
                    ...
                    j = function (b)
                    {
                        var c = this,
                                ...
                                i = function (b, f)
                                {
                                    ...
                                    var i = k(b, h);
                                    if (null == i)
                                        return a(this).remove(), void e.reject(
                                                {
                        ...
                        if (f && b instanceof File)
                        {
                            ...
                            b instanceof Object && b.hasOwnProperty("path") && h(b.path, null);
                        return e.promise()
                    },
                    k = function (b, c, d)
                    {
        ...
        }(window.jQuery), !function (a)
{
    ...
    var b = function (b, c)
    {
        this.$element = a(b), this.options = a.extend(
                {}, a.fn.bs_typeahead.defaults, c), this.matcher = this.options.matcher || this.matcher, this.sorter = this.options.sorter || this.sorter, this.highlighter = this.options.highlighter || this.highlighter, this.updater = this.options.updater || this.updater, this.source = this.options.source, this.$menu = a(this.options.menu), this.shown = !1, this.listen()
    };
    b.prototype = {
        constructor: b,
        select: function ()
                ...
                return this.each(function ()
                {
                    ...
                    for (var c in g)
                        if (g.hasOwnProperty(c))
                        {
                            ...
                            if ("string" == typeof e && e in f)
                                e = f[e], e.name = g[c];
                            else
                            {
                                if (!("object" == typeof e && e.name in f))
                                    continue;
            ...
            a.fn.ace_spinner = function (d, e)
            {
                var f, g = this.each(function ()
                {
                    var b = a(this),
                            ...
                            h = "object" == typeof d && d;
                    g || (h = a.extend(
                            {}, a.fn.ace_spinner.defaults, d), b.data("ace_spinner", g = new c(this, h))), "string" == typeof d && (f = g._call(d, e))
                });
                return f === b ? g : f
        ...
        function (a, b)
        {
            function c(b, c)
            {
                ...
                if (this.settings = a.extend(
                        {}, a.fn.ace_aside.defaults, c, j), !this.settings.background || c.scroll_style || j.scroll_style || (this.settings.scroll_style = "scroll-white no-track"), this.container = this.settings.container, this.container)
                    try
                    {
                ...
                {
                    if (o(), a("body").removeClass("modal-open").css("padding-right", ""), "invisible" == this.settings.backdrop)
                        try
                        {
                    ...
                    {
                        if (ace.vars.touch)
                            m.css("max-height", (h ? m.height() : l.height()) + "px");
                        else
                        {
