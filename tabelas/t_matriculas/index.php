...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery("#btn_excel").click(function () {
            ...
            window.open("<?php echo URL_SYS . 'tabelas/t_matriculas/'; ?>excel.php" + filtro);
        });
        loadNivel();
    ...
    function carregarTabela(tipo, codigo) {
        jQuery.gAjax.load("<?php echo URL_SYS . 'tabelas/t_matriculas/'; ?>load.php", {filtro_curso: jQuery("#cur_int_codigo").val(), filtro_escola: jQuery("#filtro_escola").val(), filtro_tipo: jQuery("#filtro_tipo").val(), filtro_agrupamento: jQuery("#filtro_agrupamento").val(), filtro_periodo: jQuery("#filtro_periodo").val(), ordenacao: jQuery("#ordenacao").val(), tipo: tipo, codigo: codigo}, "#div_load");
    }
</script>