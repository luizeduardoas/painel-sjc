...
$html .= '  <h3 class="header smaller lighter green">Cron de atualização de módulo</h3>';
$html .= '  <p>Ao executar esse Cron, o sistema irá buscar os dados de módulo no Moodle a atualizar no painel.</p>';
...
<script>
    function __executar() {
        ...
        window.location.href = "<?php echo URL_SYS . 'administracao/cronmodulo/'; ?>exec/";
    }
</script>