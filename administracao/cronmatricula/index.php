...
$html .= '  <h3 class="header smaller lighter green">Cron de atualização de matrícula</h3>';
$html .= '  <p>Ao executar esse Cron, o sistema irá buscar os dados de matrícula no Moodle a atualizar no painel.</p>';
...
<script>
    function __executar() {
        ...
        window.location.href = "<?php echo URL_SYS . 'administracao/cronmatricula/'; ?>exec/";
    }
</script>