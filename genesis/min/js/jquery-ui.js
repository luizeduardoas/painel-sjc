...
})(function (e)
{
    ...
    }, e.widget.extend = function (t)
    {
        for (var i, s, n = u.call(arguments, 1), a = 0, o = n.length; o > a; a++)
            for (i in n[a])
                s = n[a][i], n[a].hasOwnProperty(i) && void 0 !== s && (t[i] = e.isPlainObject(s) ? e.isPlainObject(t[i]) ? e.widget.extend(
        ...
        option: function (t, i)
        {
            ...
            if ("string" == typeof t)
                if (o = {}, s = t.split("."), t = s.shift(), s.length)
                {
                    ...
                    {}, this.options[t]), a = 0; s.length - 1 > a; a++)
                        n[s[a]] = n[s[a]] ||
                                {}, n = n[s[a]];
