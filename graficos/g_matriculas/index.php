...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery("#btn_excel").click(function () {
            window.open("<?php echo URL_SYS . 'graficos/g_matriculas/'; ?>excel.php");
        });
        loadNivel();
    });
    ...
    function carregarGrafico(tipo) {
        jQuery.gAjax.load("<?php echo URL_SYS . 'graficos/g_matriculas/'; ?>load.php", {filtro_curso: jQuery("#cur_int_codigo").val(), filtro_periodo: jQuery("#filtro_periodo").val(), tipo: tipo}, "#div_load");
    }
</script>