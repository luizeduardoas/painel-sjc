...
if (!is_null($relatorio->getRel_var_titulo())) {
    ...
    if ($arrReturn["status"]) {
        if (count($arrReturn["dados"])) {
            ...
            echo '<p class="alert alert-danger center"><i class="ace-icon fa fa-exclamation-circle bigger-150 icon-animated-vertical"></i> Nenhum dado foi encontrado para esses filtros.</p>';
        }
    } else {
        echo '<p class="alert alert-danger center"><i class="ace-icon fa fa-exclamation-circle bigger-150 icon-animated-vertical"></i> ' . $arrReturn["msg"] . '</p>';
    }
} else {
    echo '<p class="alert alert-danger center"><i class="ace-icon fa fa-exclamation-circle bigger-150 icon-animated-vertical"></i> Desculpa, mas não encontramos esse relatório.</p>';
}
?>